...
<form role="form" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input value="<?php echo $obj->dnite;?>" maxlength="8"  onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="dnite" type="text" class="form-control"  placeholder="CARNET">
    </div>
    <div class="form-group col-md-6">
