    ...
    <div class="table-title">
      <div class="row">
        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
          <h2 class="ml-lg-2">Personal Administrativo</h2>
        </div>
    ...
    <nav aria-label="Page navigation example">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    ...
                    <p>Mostrando <?php echo $productosPorPagina ?> de <?php echo $conteo ?> Personal dispononible</p>
                </div>
                <div class="col-xs-12 col-sm-6">
...
<form role="form" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input value="<?php echo $obj->dnifa;?>" maxlength="8"  onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="dnifa" type="text" class="form-control"  placeholder="DPI">
    </div>
    <div class="form-group col-md-6">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="modal_contact_firstname">DPI</label>
                                    <div class="input-group">
                                       
                                        <input type="text"  name="txtdni" maxlength="8" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required class="form-control" placeholder="DPI" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
...
<?php  
 ...
 if(isset($_POST['agregar']))
 {
  ...
  if(empty($dnifa)){
   $errMSG = "Por favor ingrese su DPI.";
  }
  else if(empty($nomfa)){
   $errMSG = "por favor ingrese su nombre.";
  }
  else if(empty($profefa)){
   $errMSG = "por favor ingrese su profesion.";
  }
   ...
   $errMSG = "falta su numero de telefono .";
  }

  else if(empty($direc)){
   $errMSG = "ingrese su direccion.";
  }

  else if(empty($imgFile)){
   $errMSG = "por favor seleccione alguna imagen.";
  }
   ...
   $errMSG = "por favor ingrese el rol del usuario.";
  }
  else
  {
