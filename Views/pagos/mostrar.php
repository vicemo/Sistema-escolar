...
logout</span>Cerrar sesión</a>
    ...
    <div class="table-title">
      <div class="row">
        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
          <h2 class="ml-lg-2">PAGOS CON TARJETA DE CRÉDITO Y DÉBITO</h2>
        </div>

        <div class="col-sm-12 p-0 d-flex justify-content-lg-end justify-content-center">
          <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
          <i class="material-icons">&#xE147;</i>realizar pago </a>
    ...
    <div class="card-body">
        ...
        <p class="card-text">Nombre del Alumno: Juan Pérez</p>
        <p class="card-text">Monto Pagado: $500.00</p>
        <p class="card-text">Fecha de Pago: 2023-10-18</p>
